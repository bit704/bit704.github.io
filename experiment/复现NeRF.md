# 复现NeRF<sup><a class=n href="#ref1">[1]</a></sup> 
...
<style>.n{ TEXT-DECORATION:none }</style> <!-- 功能为消除引用参考文献[1]上标中的下划线-->
...
$C_{1}$、$C_{1}$、$C_{3}$为常数，为了避免分母为0的情况，通常取$C_{1}=(K_{1}*L)^2$, $C_{1}=(K_{1}*L)^2$, $C_{3}=C_{2}/2$，一般地$K_{1}=0.01$, $K_{2}=0.03$, $L=255$。
$$
