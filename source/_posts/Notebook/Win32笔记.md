...
categories: [Notebook]
tags: [C++,API]
cover: https://tvax3.sinaimg.cn/large/0077Un8Egy1h5mqkns1t3j30d6079q2w.jpg
banner: https://tvax3.sinaimg.cn/large/0077Un8Egy1h5mqkns1t3j30d6079q2w.jpg
---
...
![窗口关系](https://docs.microsoft.com/zh-cn/windows/win32/learnwin32/images/window04.png)

窗口句柄的数据类型是 **HWND**，通过将其作为参数的函数来操作它。句柄不是指针。

原点始终在左上角：

![屏幕和窗口坐标](https://docs.microsoft.com/zh-cn/windows/win32/learnwin32/images/coordinates01.png)
...
![关闭窗口流程](https://docs.microsoft.com/zh-cn/windows/win32/learnwin32/images/wmclose01.png)
...
![COM管理过程](https://docs.microsoft.com/zh-cn/windows/win32/learnwin32/images/com05.png)
